...
[out]: 2600992721064 2600992705016 2601027697184
```
...
#生成器表达式：
(i for i in range(8))
[out]: <generator object <genexpr> at 0x000002403EB20620>
```
...
fib(6)
[out]: <generator object test at 0x000001837A277D00>
```
