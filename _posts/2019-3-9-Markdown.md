...
[//]: # (![标题示例](/images/posts/Markdown/title.png))
...
[//]: # (![标题示例-1][title_08])  
[![WSJqe0.png](https://z3.ax1x.com/2021/07/10/WSJqe0.png)](https://imgtu.com/i/WSJqe0)  

- 用“---”，只能表示二级标题。  

[//]: # (![标题示例-2][title_09])  
[![WSJLwV.png](https://z3.ax1x.com/2021/07/10/WSJLwV.png)](https://imgtu.com/i/WSJLwV)  
...
[//]: # (![文字特效示例](/images/posts/Markdown/02.png))  
[![WSJTQs.png](https://z3.ax1x.com/2021/07/10/WSJTQs.png)](https://imgtu.com/i/WSJTQs)  

and:  

[//]: # (![文字效果补充][underline])
[![WSJxW4.png](https://z3.ax1x.com/2021/07/10/WSJxW4.png)](https://imgtu.com/i/WSJxW4)  
...
[//]: # (![综合文字效果][text effects])  
[![WSJOoT.png](https://z3.ax1x.com/2021/07/10/WSJOoT.png)](https://imgtu.com/i/WSJOoT)  
...
[//]: # (![段落示例1][para_demo1])
[![WSJjFU.png](https://z3.ax1x.com/2021/07/10/WSJjFU.png)](https://imgtu.com/i/WSJjFU)  

- 段前加4个空格  
段前加4个空格表示段落的从属关系。(从属关系在列表中作用更明显，后面会讲到的)  

[//]: # (![段落示例2][para_demo2])  
[![WSJvYF.png](https://z3.ax1x.com/2021/07/10/WSJvYF.png)](https://imgtu.com/i/WSJvYF)  

### 引用

在一行文字前面加">"即可，并且可以多个套用。效果如下：
[//]: # ([引用示例]/images/posts/Markdown/03.png)  
[![WSJ7yn.png](https://z3.ax1x.com/2021/07/10/WSJ7yn.png)](https://imgtu.com/i/WSJ7yn)  
...
三个或以上的"-"or"*"都可。
效果如下图：
[//]: # (![分割线示例](/images/posts/Markdown/04.png))
[![WSJIzj.png](https://z3.ax1x.com/2021/07/10/WSJIzj.png)](https://imgtu.com/i/WSJIzj)  
...
[comment]: <> ([超链接示例2](/images/posts/Markdown/06.png))  
[![WSJ5WQ.png](https://z3.ax1x.com/2021/07/10/WSJ5WQ.png)](https://imgtu.com/i/WSJ5WQ)  
...
[//]: # (![图片示例](/images/posts/Markdown/07.png))
[![WSJHLq.png](https://z3.ax1x.com/2021/07/10/WSJHLq.png)](https://imgtu.com/i/WSJHLq)  
...
[//]: # (![list_demo][list])  
[![WSYpl9.png](https://z3.ax1x.com/2021/07/10/WSYpl9.png)](https://imgtu.com/i/WSYpl9)  
...
[//]: # (![code_demo][code])  
[![WSY9yR.png](https://z3.ax1x.com/2021/07/10/WSY9yR.png)](https://imgtu.com/i/WSY9yR)  
...
[//]: # (![emoji_photos][emoji])
[![WSYSSJ.png](https://z3.ax1x.com/2021/07/10/WSYSSJ.png)](https://imgtu.com/i/WSYSSJ)  
...
<!--以下是文中的标题链接-->
[title_08]: /images/posts/Markdown/08.png
[title_09]: /images/posts/Markdown/09.png
[text effects]: /images/posts/Markdown/10.png
[para_demo1]: /images/posts/Markdown/11.png
[para_demo2]: /images/posts/Markdown/12.png
[underline]: /images/posts/Markdown/13.png
[文章开头]: #基本语法
[baidu]: https://www.baidu.com
...
转载请注明：[南梦婷的博客](https://norah2.github.io) » [点击阅读原文](https://norah2.github.io/2019/03/Markdown/) 
